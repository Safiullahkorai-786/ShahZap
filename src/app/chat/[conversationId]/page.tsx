...
const LANG_LABELS: Record<string, string> = {
  sq: 'Albanian', ar: 'Arabic', bn: 'Bengali', bg: 'Bulgarian', zh_cn: 'Chinese (Simplified)',
  ...
  hi: 'Hindi', hu: 'Hungarian', ig: 'Igbo', id: 'Indonesian', it: 'Italian', ja: 'Japanese',
  kn: 'Kannada', kk: 'Kazakh', km: 'Khmer', ko: 'Korean', lv: 'Latvian', lt: 'Lithuanian',
  mk: 'Macedonian', ms: 'Malay', ml: 'Malayalam', mr: 'Marathi', mn: 'Mongolian', ne: 'Nepali',
  ...
  sl: 'Slovenian', es: 'Spanish', sw: 'Swahili', sv: 'Swedish', tl: 'Tagalog', th: 'Thai',
  tr: 'Turkish', uk: 'Ukrainian', ur: 'Urdu', uz: 'Uzbek', vi: 'Vietnamese', yo: 'Yoruba',
}
